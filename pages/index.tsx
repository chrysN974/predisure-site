export default function Home() {
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial", backgroundColor: "#0f172a", color: "#fff", minHeight: "100vh" }}>
      ...
      <form action="https://formspree.io/f/mzzekjvq" method="POST" style={{ maxWidth: "500px", margin: "0 auto" }}>
