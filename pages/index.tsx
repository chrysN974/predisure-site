export default function Home() {
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial", backgroundColor: "#001f3d", color: "#fbbf24", minHeight: "100vh" }}>
      ...
      <form action="https://formspree.io/f/xblgpvwg" method="POST" style={{ maxWidth: "500px", margin: "0 auto" }}>
        ...
        <button type="submit" style={{ backgroundColor: "#001f3d", padding: "0.75rem", border: "none", cursor: "pointer", borderRadius: "4px", color: "#fbbf24" }}>
          Send Request
        </button>
      </form>
    </div>
